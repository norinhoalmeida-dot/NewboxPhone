...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NEWBOX PHONES — iPhones Premium com Garantia" },
      { name: "description", content: "Loja premium especializada Apple. iPhones lacrados e seminovos com 1 ano de garantia, nota fiscal e envio para todo o Brasil." },
      { name: "author", content: "NEWBOX PHONES" },
      { property: "og:title", content: "NEWBOX PHONES — iPhones Premium com Garantia" },
      { property: "og:description", content: "Loja premium especializada Apple. iPhones lacrados e seminovos com 1 ano de garantia, nota fiscal e envio para todo o Brasil." },
